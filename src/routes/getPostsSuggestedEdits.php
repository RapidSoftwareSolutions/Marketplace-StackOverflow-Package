<?php
$app->post('/api/StackOverflow/getPostsSuggestedEdits', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'posts/'.$post_data['args']['postIds'].'/suggested-edits';
    $body = array();
