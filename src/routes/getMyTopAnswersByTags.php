<?php
$app->post('/api/StackOverflow/getMyTopAnswersByTags', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'clientKey', 'tagList']);
    ...
    $query_str = $settings['api_url'] . 'me/tags/'.$post_data['args']['tagList'].'/top-answers';
    $body = array();
