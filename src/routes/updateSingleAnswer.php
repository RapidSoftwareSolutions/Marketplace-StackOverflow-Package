<?php
$app->post('/api/StackOverflow/updateSingleAnswer', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'clientKey', 'answerId', 'answerBody', 'answerComment']);
