<?php
$app->post('/api/StackOverflow/getUserUnreadNotifications', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'users/'.$post_data['args']['userId'].'/notifications/unread';
    $body = array();
