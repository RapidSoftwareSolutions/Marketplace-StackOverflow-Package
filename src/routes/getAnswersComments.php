<?php
$app->post('/api/StackOverflow/getAnswersComments', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'clientKey', 'answerIds']);
    ...
    $query_str = $settings['api_url'] . 'answers/' . $post_data['args']['answerIds'] . '/comments';
    $body = array();
