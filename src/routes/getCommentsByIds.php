<?php
$app->post('/api/StackOverflow/getCommentsByIds', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'clientKey', 'commentIds']);
    ...
    $query_str = $settings['api_url'] . 'comments/'.$post_data['args']['commentIds'];
    $body = array();
