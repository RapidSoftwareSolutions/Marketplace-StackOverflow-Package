<?php
$app->post('/api/StackOverflow/getModeratorTags', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'tags/moderator-only';
    $body = array();
    ...
    if (isset($post_data['args']['inName']) && (strlen($post_data['args']['inName'])) > 0) {
        $body['inname'] = $post_data['args']['inName'];
    };
