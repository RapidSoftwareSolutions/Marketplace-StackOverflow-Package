<?php
$app->post('/api/StackOverflow/getUsersSuggestedEdits', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'users/'.$post_data['args']['userIds'].'/suggested-edits';
    $body = array();
