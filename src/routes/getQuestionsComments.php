<?php
$app->post('/api/StackOverflow/getQuestionsComments', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'clientKey', 'questionIds']);
    ...
    $questionIds = is_array($post_data['args']['questionIds']) ? implode(';', $post_data['args']['questionIds']) : $post_data['args']['questionIds'];
    $query_str = $settings['api_url'] . 'questions/' . $questionIds . '/comments';
    $body = array();
