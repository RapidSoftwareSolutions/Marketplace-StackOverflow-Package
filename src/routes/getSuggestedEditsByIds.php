<?php
$app->post('/api/StackOverflow/getSuggestedEditsByIds', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'clientKey', 'editIds']);
    ...
    $editIds =is_array($post_data['args']['editIds']) ? implode(';', $post_data['args']['editIds']) : $post_data['args']['editIds'];
    $query_str = $settings['api_url'] . '/suggested-edits/' . $editIds;
    $body = array();
