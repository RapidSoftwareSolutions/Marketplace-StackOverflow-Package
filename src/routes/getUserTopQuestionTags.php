<?php
$app->post('/api/StackOverflow/getUserTopQuestionTags', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'users/'.$post_data['args']['userId'].'/top-question-tags';
    $body = array();
