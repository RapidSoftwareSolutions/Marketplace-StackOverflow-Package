<?php
$app->post('/api/StackOverflow/getBadgesByIds', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'clientKey', 'badgeIds']);
    ...
    $badgeIds = implode(';', $post_data['args']['badgeIds']);
