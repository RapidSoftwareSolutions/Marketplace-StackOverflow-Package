<?php
$app->post('/api/StackOverflow/getAnswersToQuestions', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'questions/'.$post_data['args']['questionIds'].'/answers';
    $body = array();
