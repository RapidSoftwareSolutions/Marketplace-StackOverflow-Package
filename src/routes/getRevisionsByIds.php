<?php
$app->post('/api/StackOverflow/getRevisionsByIds', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'clientKey', 'revisionIds']);
    ...
    $query_str = $settings['api_url'] . 'revisions/'.$post_data['args']['revisionIds'];
    $body = array();
