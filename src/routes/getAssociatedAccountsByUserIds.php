<?php
$app->post('/api/StackOverflow/getAssociatedAccountsByUserIds', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'users/'.$post_data['args']['userIds'].'/associated';
    $body = array();
    ...
    if (isset($post_data['args']['accountTypes']) && (strlen($post_data['args']['accountTypes'])) > 0) {
        $body['types'] = $post_data['args']['accountTypes'];
    };
